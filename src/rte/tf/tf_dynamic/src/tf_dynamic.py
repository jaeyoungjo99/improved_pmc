...
class TransformFrameDynamic(object):
    ...
    def __init__(self):
        ...
        self.vehicle_state_subscriber = rospy.Subscriber(
            "app/loc/novatel_geo", PoseWithCovarianceStamped, self.on_vehicle_state)        
    ...
    def calculate_transform_from_ego_to_world(self):
        ...
        transform.rotation.z = self.vehicle_state.pose.pose.orientation.z
        transform.rotation.w = self.vehicle_state.pose.pose.orientation.w
